...
const BOOTSTRAPS = Object.freeze({
  root: new URL('../bootstrap/bootstrap-root.js', import.meta.url),
  worker: new URL('../bootstrap/bootstrap-worker.js', import.meta.url),
  worklet: new URL('../bootstrap/bootstrap-worklet.js', import.meta.url),
});
