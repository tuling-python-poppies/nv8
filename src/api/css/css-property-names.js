/**
 * 真实 Edge 151 的 CSS 属性名清单（745 个），顺序即
 * `Object.getOwnPropertyNames(div.style)` 的真实枚举顺序。
 *
 * 由 `scripts/collect-edge-css-properties.mjs` 采集，
 * fixture 在 `fixtures/fingerprint/edge-css-properties.json`。
 * 这里生成成模块是因为 Realm 内没有文件系统。
 *
 * 顺序不要排序——枚举顺序本身就是可观测的。
 */
export const CSS_PROPERTY_NAMES = Object.freeze([
  "accentColor",
  "additiveSymbols",
  "alignContent",
  "alignItems",
